...
public class Customer {
    ...
    private String defaultCreditCardNumber;
...
// ------------------- Constructors -------------------
     ...
     */
    public Customer(String id, String name, String address, String password, String securityQuestion, String securityAnswer, String creditCardNumber) {
        ...
        if (creditCardNumber == null || creditCardNumber.isEmpty()) {
            throw new IllegalArgumentException("Credit card number must not be null or empty");
        }
        this.customerID = id;
        ...
        this.defaultCreditCardNumber = creditCardNumber;
    }

    /**
     * Constructs a new customer object with name and address
     */
...
// ------------------- Getters -------------------
    ...
    /**
     * Gets default credit card number.
     *
     * @return the default credit card number
     */
    public String getDefaultCreditCardNumber() {
        return defaultCreditCardNumber;
    }
...
// ------------------- Setters -------------------
    ...
    /**
     * Sets default credit card number.
     *
     * @param defaultCreditCardNumber the default credit card number
     */
    public void setDefaultCreditCardNumber(String defaultCreditCardNumber) {
        this.defaultCreditCardNumber = defaultCreditCardNumber;
    }
...
// ------------------- Utilities -------------------
    ...
    public Customer copy() {
        return new Customer(this.getCustomerID(), this.getCustomerName(), this.customerAddress, this.customerPassword, this.customerSecurityQuestion, this.customerSecurityAnswer, this.defaultCreditCardNumber);
    }
...
// ------------------- toString(). -------------------
    ...
    public String toString() {
        return "Customer{" +
                ...
                ", Default Credit Card Number='" + defaultCreditCardNumber + '\'' +
                '}';
    }
    ...
    public String toUIString() {
        return String.format(
                "| ID: %-10s | Name: %-20s | Address: %-25s | Password: %-15s | Question: %-40s | Answer: %-20s | Default Credit Card Number: %-25s |",
                customerID,
                customerName,
                customerAddress,
                customerPassword,
