...
// ------------------- Getters -------------------
    ...
    /**
     * Gets cos bank customer bank.
     *
     * @param customer the customer
     * @return the cos bank customer bank
     */
    public CustomerBank getCosBankCustomerBank(Customer customer) {
        return getCosBank().getCustomersBank(customer);
    }
...
// ------------------- Adders -------------------
    ...
    /**
     * Add customerBank account to bank arrayList
     * Calls createCustomerToBank(customer object, creditLimit)
     *
     * @param customer    the customer
     * @param creditLimit the credit limit
     * @throws IllegalArgumentException if the customer is null or creditLimit is negative
     */
    public void addCustomerBank(Customer customer, String creditCardNumber, double creditLimit) {
        if (customer == null) {
        ...
        cosBank.createCustomerToBank(customer,creditCardNumber, creditLimit);
    }
...
// ------------------- File Save -------------------
    // Format: customerID, customerName, customerAddress, customerPassword, customerQuestion, customerAnswer
    /**
    ...
    public void loadCustomersFromFile(String fileName) {
            try {
                ...
                while (reader.hasNextLine()) {
                    ...
                    // Found Format: customerID, customerName, customerAddress, customerPassword, customerQuestion, customerAnswer
                    if (parts.length == 6) {
                        ...
                        Customer customerRead = new Customer(customerID, customerName, customerAddress, customerPassword, customerSecurityQuestion, customerSecurityAnswer);
...
// ------------------- File Save -------------------
    ...
    public void saveAllData() throws IOException {
        ...
        cosBank.saveBankToFile("bank.txt");
    ...
    public void loadAllData() throws IOException {
        ...
        cosBank.loadBankFromFile("bank.txt", customers);
