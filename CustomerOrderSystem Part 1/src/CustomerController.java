...
// ------------------- Utilities -------------------
     ...
     * @return the order
     */
    public Order createOrderController(Cart cart, Customer customer, CustomerBank customerBank) {
        if (cart == null || customerBank == null) {
            return null;
        }
        ...
        return customerOrderSystemUserInterfaceController.getOrderController().createSubmitOrderController(cart, customer, customerBank, deliveryMethod);
    }
