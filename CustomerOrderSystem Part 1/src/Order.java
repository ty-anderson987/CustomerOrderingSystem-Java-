...
// ------------------- Order Utilities -------------------
     ...
     * @return the boolean
     */
    public boolean submitOrder(Customer customer, String customerBankID, String cardNumber, Bank bank, CustomerOrderSystem customerOrderSystem) {
        // Check if the BankID exists
        if (!bank.doesBankIDNumberExist(customerBankID)) {
            return false;
        }
        ...
        // Send the customer/bank info to the bank for processing payment
        String authCode = bank.processTransaction(customer, customerBankID, cardNumber, this.orderTotal);
        if (authCode == null) {
        ...
        System.out.println("Order submitted successfully! Authorization code: " + authCode);
        return true;
    }
